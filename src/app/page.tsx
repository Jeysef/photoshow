            ...
            <div id="about" className="mx-auto flex max-w-7xl flex-col items-center justify-center overflow-hidden px-8">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
                    <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                        ...
                        <Text>
                            Photoshow is a web application that allows users to create stunning photo slideshows with ease. Whether you want to showcase your
                            travel adventures, highlight your portfolio, or create a memorable presentation, Photoshow has got you covered.
                        </Text>
                        <Text className="mt-4">
